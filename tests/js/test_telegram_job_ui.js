...
if(!dom.window.document.getElementById('rsTgAnalyze')||!dom.window.document.getElementById('rsTgToken')||!dom.window.document.getElementById('rsTgReview'))throw Error('three-step setup wizard missing');
if(dom.window.document.querySelectorAll('#rsTgSetup [data-rs-step]').length!==3)throw Error('wizard is not three steps');
