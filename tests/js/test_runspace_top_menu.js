...
ok('legacy hamburger is visually removed',/#tab-jobs #wbMenuBtn,[\s\S]{0,100}#tab-jobs #btnRunQuick \{ display:none !important/.test(CSS));
...
ok('status copy distinguishes running/stopped/problem',/Running normally/.test(JS)&&/Needs attention/.test(JS)&&/Stopped/.test(JS));
