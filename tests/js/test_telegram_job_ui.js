...
if(!dom.window.document.getElementById('rsTgAnalyze')||!dom.window.document.getElementById('rsTgToken')||!dom.window.document.getElementById('rsTgReview'))throw Error('four-step setup wizard missing');
